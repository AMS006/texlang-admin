        ...
        <div className='px-6 py-8 font-sans  bg-white'>
            ...
            <div>
                <div className='flex gap-2.5 no-print'>
                    {selectedInvoice?.status === 'Pending' && <button disabled={approvingInvoice} onClick={handleApproveInvoice} className={`bg-blue-500 text-white px-2.5 py-1.5 no-print ${approvingInvoice ? 'opacity-60' : 'hover:bg-blue-600'}`}>{approvingInvoice ? 'Approving...' : 'Approve Invoice'}</button>}
