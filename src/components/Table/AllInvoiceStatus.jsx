...
import { allInvoicesStatusColumn } from '../../data/columns';
import './style.css'
...
const AllInvoicesStatusTable = () => {

    const { allInvoicesStatus, loading } = useSelector((state) => state.invoice)
    const data = useMemo(() => allInvoicesStatus, [allInvoicesStatus])
    ...
    const {
        ...
        {
            columns: allInvoicesStatusColumn,
            data,
        },
        useGlobalFilter,
        useSortBy,
                    ...
                    </thead>
                    {
                        page.length > 0 ?
                            ...
                            (
                                <tbody>
                                    <tr>
                                        <td colSpan={allInvoicesStatusColumn.length} className="text-center py-1.5 border w-full">
...
export default AllInvoicesStatusTable;
