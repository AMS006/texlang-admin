...
import { reAssignTranslatorColumn } from '../../data/columns';
import './style.css'
...
const ReAssignTranslatorTable = () => {

    const { loading, reAssignTranslatorsWorks } = useSelector((state) => state.translator);
    const data = useMemo(() => reAssignTranslatorsWorks, [reAssignTranslatorsWorks])
    const {
        getTableProps,
        getTableBodyProps,
        headerGroups,
        ...
        {
            columns: reAssignTranslatorColumn,
            data,
        },
        useGlobalFilter,
        useSortBy,
                    ...
                    </thead>
                    {
                        page.length > 0 ?
                            ...
                            (
                                <tbody>
                                    <tr>
                                        <td colSpan={reAssignTranslatorColumn.length} className="text-center py-1.5 border w-full">
...
export default ReAssignTranslatorTable;
